...
import com.example.be_sprint2.service.ICategoryService;
import com.example.be_sprint2.service.IProductService;
import com.example.be_sprint2.service.ISizeService;
...
public class ProductController {
    ...
    public ResponseEntity<Page<ProductDto>> getAllProduct(@RequestParam(name = "page",defaultValue = "0",required = false) Integer page,
                                                          ...
                                                          @RequestParam(name = "maxPrice",defaultValue = "10000",required = false) Integer maxPrice) {
